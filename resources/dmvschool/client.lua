...
Citizen.CreateThread(function()
    while true do
		...
		TriggerEvent("pNotify:SendNotification",{
            text = "You are speeding! <b style='color:#B22222'>Slow down!</b><br /><br />You are driving in a <b style='color:#DAA520'>30 mph</b> zone!",
            type = "alert",
            timeout = (2000),
            layout = "bottomCenter",
            queue = "global"
		...
		TriggerEvent("pNotify:SendNotification",{
            text = "You are speeding! <b style='color:#B22222'>Slow down!</b><br /><br />You are driving in a <b style='color:#DAA520'>49 mph</b> zone!",
            type = "alert",
            timeout = (2000),
            layout = "bottomCenter",
            queue = "global"
		...
		TriggerEvent("pNotify:SendNotification",{
            text = "You are speeding! <b style='color:#B22222'>Slow down!</b><br /><br />You are driving in a <b style='color:#DAA520'>74 mph</b> zone!",
            type = "alert",
            timeout = (2000),
            layout = "bottomCenter",
            queue = "global"
