...
function spawnPlayer(spawnIdx, cb)
    ...
    Citizen.CreateThread(function()
        ...
        TriggerEvent('es_roleplay:removeAllWeapons')

	   -- Clear police wanted level on spawn
        ...
        if playerPed and playerPed ~= -1 then
            ...
            if autoSpawnEnabled then
                if NetworkIsPlayerActive(PlayerId()) then
                    if (diedAt and (GetTimeDifference(GetGameTimer(), diedAt) > 2000)) or respawnForced then -- 2000
