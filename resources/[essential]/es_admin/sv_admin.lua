...
-- 911 news
TriggerEvent('es:addAdminCommand', 'copblast', permission.normal, function(source, args, user)
	table.remove(args, 1)
	TriggerClientEvent('chatMessage', -1, "^5[LSPD]", {30, 144, 255}, " (^1 LSPD: ^3" .. GetPlayerName(source) .." ^0 ) " .. table.concat(args, " "))
end, function(source, args, user)
	TriggerClientEvent('chatMessage', source, "SYSTEM", {255, 0, 0}, "Insufficienct permissions!")
end)

-- tweet
TriggerEvent('es:addAdminCommand', 'tweet', permission.normal, function(source, args, user)
	table.remove(args, 1)
...
-- Dice
TriggerEvent('es:addAdminCommand', 'rolldice', permission.normal, function(source, args, user)
	table.remove(args, 1)
	TriggerClientEvent('chatMessage', -1, "^3[Gambling]", {255, 0, 0}, " ^3" .. GetPlayerName(source) .." ^5Rolls a dice and gets the number ^0 " .. math.random(0, 100, " "))
end, function(source, args, user)
	TriggerClientEvent('chatMessage', source, "SYSTEM", {255, 0, 0}, "Insufficienct permissions!")
end)
...
TriggerEvent('es:addGroupCommand', 'dv', "admin" function(source, args, user)
 ...
 function(source, args, user)
    TriggerClientEvent('chatMessage', source, "SYSTEM", {255, 0, 0}, "Not enough privileges for this feature!")
end)
