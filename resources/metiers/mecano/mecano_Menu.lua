...
itemMenuGeneral = {
    ...
    ['Items'] = {
        UrgenceMenu,
        {['Title'] = 'Analyze vehicle', ['Function'] = getStatusVehicle, ['Close'] = false},
        {['Title'] = 'Quick repair', ['Function'] = repareVehicle, ['Close'] = false},
        {['Title'] = 'Complete repair', ['Function'] = fullRepareVehcile, ['Close'] = false},
        {['Title'] = 'Unlock the doors', ['Function'] = unlockVehiculeForAll, ['Close'] = false},
        {['Title'] = 'Open door', ['SubMenu'] = {
            ['Title'] = 'Opening door',  ['Items'] = {
                {['Title'] = 'Drivers door', ['Function'] = openVehicleDoorData, ['Porte'] = 0, ['Close'] = false},
              {['Title'] = 'Passengers door', ['Function'] = openVehicleDoorData, ['Porte'] = 1, ['Close'] = false},
                {['Title'] = 'Rear drivers door', ['Function'] = openVehicleDoorData, ['Porte'] = 2, ['Close'] = false},
                {['Title'] = 'Rear passengers door', ['Function'] = openVehicleDoorData, ['Porte'] = 3, ['Close'] = false},
                {['Title'] = 'Hood', ['Function'] = openVehicleDoorData, ['Porte'] = 4, ['Close'] = false},
                {['Title'] = 'Trunk', ['Function'] = openVehicleDoorData, ['Porte'] = 5, ['Close'] = false},
                {['Title'] = 'Right truck door', ['Function'] = openVehicleDoorData, ['Porte'] = 6, ['Close'] = false},
                {['Title'] = 'Left truck door', ['Function'] = openVehicleDoorData, ['Porte'] = 7, ['Close'] = false},
                {['Title'] = 'All doors', ['Function'] = openVehicleDoorData, ['Porte'] = -1, ['Close'] = false},
            }
        }},
        {['Title'] = 'Door Closure', ['SubMenu'] = {
            ['Title'] = 'Door Closure', ['Items'] = {
                {['Title'] = 'Driver\'s door', ['Function'] = closeVehicleDoorData, ['Porte'] = 0, ['Close'] = false},
                {['Title'] = 'Passenger\'s door', ['Function'] = closeVehicleDoorData, ['Porte'] = 1, ['Close'] = false},
                {['Title'] = 'Rear driver\'s door', ['Function'] = closeVehicleDoorData, ['Porte'] = 2, ['Close'] = false},
                ...
                {['Title'] = 'Chest', ['Function'] = closeVehicleDoorData, ['Porte'] = 5, ['Close'] = false},
                {['Title'] = 'Straight truck door', ['Function'] = closeVehicleDoorData, ['Porte'] = 6, ['Close'] = false},
                {['Title'] = 'Left truck door', ['Function'] = closeVehicleDoorData, ['Porte'] = 7, ['Close'] = false},
                {['Title'] = 'All the doors', ['Function'] = closeVehicleDoorData, ['Porte'] = -1, ['Close'] = false},
            }
        }},
		{['Title'] = 'Cleaning the Vehicle', ['Function'] = MECANO_wash},
		{['Title'] = 'Remove Vehicle', ['Function'] = MECANO_deleteVehicle},
		{['Title'] = 'Show / hide help', ['Function'] = toogleHelperLine, ['Close'] = false},
    }
}

itemMenuChoix = {
    ['Title'] = 'Mechanic vehicle garage',
    ['Items'] = {
