...
AddEventHandler( "MSQonClientMapStart", function()
	...
	if ACL ~= nil then
		if ACL:isAdministrator( source ) then
			TriggerClientEvent( "chatMessage", source, "", {255,255,255}, "^3Logget ind som administrator." )
		elseif ACL:isModerator( source ) then
			TriggerClientEvent( "chatMessage", source, "", {255,255,255}, "^3Logget ind som moderator." )
		end
	end
end)
