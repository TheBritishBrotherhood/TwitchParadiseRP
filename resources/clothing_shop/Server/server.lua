...
function updatePlayerClothes1(values)
...
AddEventHandler("clothing_shop:SpawnPlayer_server", function()
	if(getIsFirstConnection() == 1) then
		createPlayerIntoDbClothes()
