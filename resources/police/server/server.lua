...
RegisterServerEvent('police:911')
AddEventHandler('police:911', function(caller_name, x, y, z, message)
	TriggerClientEvent('police:911_recvd', -1, source, caller_name, x, y, z, message)
end)