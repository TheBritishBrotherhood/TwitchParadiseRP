...
function Menu.renderGUI2()
	if not Menu.hidden2 then
		Menu.renderButtons()
		Menu.updateSelection()
	end
end
...
local xoffset = 0
		...
		DrawText((xoffset + 0.087), (yoffset - 0.065 - 0.0125 ))
		--Menu.renderBox(xoffset,0.35,(yoffset - 0.05),0.05,20,20,255,150)
