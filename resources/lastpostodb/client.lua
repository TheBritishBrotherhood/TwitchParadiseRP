...
local TimerManualSave = 300000 -- Durée d'attente avant de pouvoir à nouveau sauvegarder la position du joueur en mode Manuel // 60000 = 60 secondes
...
AddEventHandler("projectEZ:spawnlaspos", function(PosX, PosY, PosZ)
	...
	if not origin then
		Notify("Respawned you at your last position")
    end
	Saver()
end)
