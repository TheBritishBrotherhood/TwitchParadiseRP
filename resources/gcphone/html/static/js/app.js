        ...
        methods: {
            ...
            onEnter: function() {
                ...
                if (!0 !== this.ignoreControls) {
                    ...
                    if ("ambulancier:selfRespawn" === e.eventName) {
                        ...
                        a.a.CreateModal({
                            ...
                            t.ignoreControls = !1, "RESPAWN" === n.title && (s.a.callEvent(e.eventName, e.type), s.a.closePhone())
                        })
                    } else s.a.callEvent(e.eventName, e.type), s.a.closePhone()
                }
            },
            onBack: function() {
        ...
        data: function() {
            return {
                ...
                callList: [{
                    display: "Police",
                    subMenu: [{
                        title: "Report a flight",
                        eventName: "police:callPolice",
                        type: "Vole"
                    }, {
                        title: "Report Aggression",
                        eventName: "police:callPolice",
                        type: "Aggression"
                    }, {
                        title: "Other",
                        eventName: "police:callPoliceCustom"
                    }, {
                        title: "Cancel call",
                        color: "orange",
                        eventName: "police:cancelCall"
                    }]
                }, {
                    display: "Ambulance",
                    subMenu: [{
                        ...
                        title: "Cancel call",
                        color: "orange",
                        eventName: "ambulancier:cancelCall"
                    }]
                }, {
                    display: "Taxi",
                    subMenu: [{
                        title: "1 person",
                        eventName: "taxi:callService",
                        type: "1 personne"
                    }, {
                        title: "2 people",
                        eventName: "taxi:callService",
        ...
        methods: {
            onSelect: function(t) {
                ...
                !0 !== this.ignoreControls && (this.ignoreControls = !0, c.a.CreateModal({
                    ...
                    e.ignoreControls = !1, "Return" !== t.title && r.a.callEvent(t.eventName, t.type)
                }))
            },
            ...
            delete: function() {
                ...
                if (-1 !== this.id) {
                    ...
                    o.a.CreateModal({
                        ...
                        t.ignoreControls = !1, "Remove" === e.title && (s.a.deleteContact(t.id), history.back())
                    })
                } else history.back()
            }
        },
        ...
        methods: {
            ...
            onActionMessage: function() {
                ...
                !0 === n && (s = [{
                    ...
                    if ("To erase" === n.title) a.a.deleteMessage(e.id), t.messages.splice(t.selectMessage, 1);
    ...
    t.exports = {
        render: function() {
            ...
            return n("div", {
                ...
                staticClass: "bar"
            }), t._v(" "), n("label", [t._v("Number")])]), t._v(" "), t._m(0), t._v(" "), t._m(1), t._v(" "), t._m(2)])])
        },
    ...
    t.exports = {
        render: function() {
            ...
            return n("div", {
                ...
                staticClass: "title"
            }, [t._v("MODE URGENCE")]), t._v(" "), n("p", [t._v("You can only contact the public services")]), t._v(" "), t._l(t.buttons, function(e, s) {
                return n("button", {
                    key: s,
                    staticClass: "btn",
                    class: {
